...
def run_analysis(df, layout_lines=None):
    ...
    # Rename first unnamed numeric columns if necessary
    rename_map = {
        "AssayFunction": "Function",
        "AssayClassification": "Cq",
        "LinkedICWellID": "Ampl",
        "LinkedICAssay": "Slope",
    ...
    for col in ["Well_ID", "Cq", "Ampl", "Slope", "Threshold"]:
    ...
    numeric_cols = [c for c in ["Cq", "Ampl", "Slope", "Threshold"] if c in df.columns]
